...
These screenshots were captured from the production deployment at https://gravity-sandbox-eight.vercel.app.
...
Run the app, then capture fresh images with Playwright or the browser dev tools. Keep replacement files at:

- `docs/screenshots/gravity-sandbox-desktop.png`
- `docs/screenshots/gravity-sandbox-mobile.png`
